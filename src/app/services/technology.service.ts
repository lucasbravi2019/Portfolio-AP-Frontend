...
export class TechnologyService {
  ...
  createTechnology(technology: TechnologyRequest): Observable<TechnologyResponse> {
    this.header = this.loginService.checkUserlogged(this.header)
  ...
  updateTechnology(id: number, technology: TechnologyRequest): Observable<TechnologyResponse> {
    this.header = this.loginService.checkUserlogged(this.header)
